...
print("\n_________________________Матриця планування для ОЦКП(із нормованими значеннями факторів)_________________________")
print(table1)
...
print("\n______________________________Матриця планування для ОЦКП (із натуралізованими значеннями факторів)__________________________")
print(table2)
...
if Gp < Gt:
    ...
    print("\n__________Лінійне рівняння регресії__________  \nŷ = {:.3f} + {:.3f} * X1 + {:.3f} * X2 + {:.3f} * X3".format(b[0], b[1], b[2],
                                                                                                      b[3]))
    print("\n_______________Рівняння регресії з ефектом взаємодії____________________________________")
    print("y=" + str(b[0]) + "+" + str(b[1]) + "*x1+" + str(b[2]) + "*x2+" + str(b[3]) + "*x3+" + str(
        b[4]) + "*x1*x2+" + str(b[5]) + "*x1*x3+" + str(b[6]) + "*x2*x3+" + str(b[7]) + "*x1*x2*x3")
